<?php include('server.php');
   ...
   if (isset($_GET['edit'])) {
	...
	$email = $record['email'];
	$studentsrecord = $record['studentsrecord'];
	$id = $record['id'];
  ...
  <h1>students record Updated</h1>
	...
	<table>
		...
		<tr>
			...
			<td><?php echo $row['studentsrecord']; ?></td>
			<td>
...
<div class="footer">
  <footer>Copyright &copy; nexco.com</footer>
</div>  
</body>
